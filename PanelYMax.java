 ...
 * @author theola1
 */
public class PanelYMax extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        FieldYMax = new javax.swing.JTextField();
        ...
        FieldYMax.setEditable(false);
        FieldYMax.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FieldYMaxActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(FieldYMax, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(LabelYMax))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addComponent(BttnKlar, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Bttn1)
                    .addComponent(Bttn2)
    ...
    private void Bttn7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn7ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"7"); //Adds the number "7" to the textfield
    ...
    private void BttnPunktActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BttnPunktActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"."); //Adds a "." to the textfield
    ...
    private void Bttn8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn8ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"8"); //Adds the number "8" to the textfield
    ...
    private void Bttn9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn9ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"9"); //Adds the number "9" to the textfield
    ...
    private void Bttn6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn6ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"6"); //Adds the number "6" to the textfield
    ...
    private void Bttn5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn5ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"5"); //Adds the number "5" to the textfield
    ...
    private void Bttn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn4ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"4"); //Adds the number "4" to the textfield
    ...
    private void Bttn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn1ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"1"); //Adds the number "1" to the textfield
    ...
    private void Bttn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn2ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"2"); //Adds the number "2" to the textfield
    ...
    private void Bttn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn3ActionPerformed
        FieldYMax.setText(FieldYMax.getText()+"3"); //Adds the number "3" to the textfield
    ...
    private void Bttn0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bttn0ActionPerformed
        ...
        FieldYMax.setText(FieldYMax.getText()+"0"); //Adds the number "0" to the textfield
    ...
    private void BttnKlarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BttnKlarActionPerformed
     PanelRaknare.YMax = Double.parseDouble(FieldYMax.getText());
    ...
    private void BttnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BttnBackActionPerformed
        String Bort =  FieldYMax.getText();
        int langdBort = Bort.length();
        Bort = Bort.substring(0, langdBort-1);
         FieldYMax.setText(Bort);
    }//GEN-LAST:event_BttnBackActionPerformed

    private void FieldYMaxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FieldYMaxActionPerformed
    // TODO add your handling code here:
    }//GEN-LAST:event_FieldYMaxActionPerformed
    ...
    private javax.swing.JTextField FieldYMax;
